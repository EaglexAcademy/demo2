...
function vw_hair_salon_admin_theme_style() {
   ...
   wp_enqueue_style('vw-hair-salon-custom-admin-style', get_template_directory_uri() . '/inc/getstarted/getstarted.css');
   wp_enqueue_script('vw-hair-salon-tabs', get_template_directory_uri() . '/inc/getstarted/js/tab.js');
}
...
<div class="wrapper-info">
    ...
    <div class="tab-sec">
		<div class="tab">
		  <button class="tablinks" onclick="vw_hair_salon_open_tab(event, 'lite_theme')"><?php esc_html_e( 'Getting Started', 'vw-hair-salon' ); ?></button>		  
